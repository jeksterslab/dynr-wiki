...
- For users with Apple Silicon (M1, M2, or M3), you may need to specify the architecture of the container as follows:

```bash
docker pull --platform linux/x86_64 jeksterslab/dynr-rocker:latest
docker run --rm --platform linux/x86_64 -ti -e PASSWORD=yourpassword -p 127.0.0.1:8787:8787 jeksterslab/dynr-rocker
```
