...
```bash
docker run --rm -ti -e PASSWORD=yourpassword -p 8787:8787 jeksterslab/dynr-rocker@sha256:f60403254cd6f2057ba97c24e0990a2d9f7a7c4f163210b312b490ee6d155f0a
```
